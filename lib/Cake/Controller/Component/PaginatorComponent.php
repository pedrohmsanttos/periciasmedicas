 ...
 */
	public function paginate($object = null, $scope = array(), $whitelist = array()) {
		...
		if (!$results) {
			...
			//Removendo a ligação com o usuário na ligação do modelo - #17351
			// if($object->useTable == "publicacao"){
			// 	$extra['joins']['2']['alias'] = "UsuarioAtendimento";
			// 	$extra['joins']['2']['conditions']['0'] = "Atendimento.usuario_id = UsuarioAtendimento.id";
			// }
