	...
	var u = function(t, n) {
		...
		var n = {
			content : {
				...
				click_close : n.click_close ? n.click_close : null
			}
		};
		r = e.extend(true, {}, n, r);
		...
		if (t.content.click_close) {
			e.find('[data-growl="url"]').attr("onclick", 'javascript:$(".alert").remove();');
			e.find('[data-growl="url"]').css({
				position : "absolute",
				top : "0px",
				left : "0px",
	...
	f.prototype = {
		update : function(e, t) {
			...
			case "url":
				...
				break;
			case "click_close":
				this.$template.find('[data-growl="url"]').attr("onclick", t);
				break;
			case "type":
